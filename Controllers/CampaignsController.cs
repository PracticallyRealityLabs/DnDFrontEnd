...
namespace DnDFrontEnd.Controllers
{
    public class CampaignsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CampaignId,CampaignName")] Campaign campaign)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CampaignId,CampaignName")] Campaign campaign)
        {
